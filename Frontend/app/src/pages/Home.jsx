...
function Home() {
        ...
        chatSocket.current.onmessage = (e) => {
            ...
            if (data.user && data.status) {
                if (data.user === otherUser) {
                    statusRef.current = data.status === 'online';
                }
            }
    ...
    }, [id, roomName, otherUser, selfUser]);
    ...
    return (
        <>
            <div className="chat-container">
                <Sidebar />
                <ChatArea username={otherUser} messages={roomName ? recentMessage[roomName] : []} onSendMessage={sendMessage} onlineStatus={statusRef.current}/>
            </div>
        </>
    )
}
